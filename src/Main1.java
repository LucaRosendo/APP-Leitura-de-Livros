...
try {
        ...
        Livro livro4 = new Livro("456", "Fantasia", "Fantasia",
                        gerenciamentoAutores.getAutores().get(0), 2000, false, status,"ERA UMA VEZ");
        livros.add(livro4);
 ...
 /*        Livro livro6 = new Livro("Reinações de Narizinho", List.of("Infantil"), "Infantil",
        ...
        Livro livro7 = new Livro("Caçadas de Pedrinho","Infantil", "Infantil",
                        gerenciamentoAutores.getAutores().get(1), 1933, true, status,"era uMA VEZ");
        livros.add(livro7);
        ...
        Livro livro8 = new Livro("Dom Casmurro", "Romance", "Romance",
                        gerenciamentoAutores.getAutores().get(2), 1899, true, status,"ERA UMAVEZ ");
        livros.add(livro8);
        ...
        Livro livro9 = new Livro("Memórias Póstumas de Brás Cubas", "Romance", "Romance",
                        gerenciamentoAutores.getAutores().get(2), 1881, true, status,"ERA UMAVEZ ");
        livros.add(livro9);
        ...
        switch (userOption) {
            case 1 -> {
                ...
                if (livroEscolhido > 0 && livroEscolhido <= livros.size()) {
                    ...
                    // Exibir conteúdo conforme o tipo de assinatura e a disponibilidade do livro
